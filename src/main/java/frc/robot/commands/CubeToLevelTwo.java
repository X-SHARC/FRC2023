...
public class CubeToLevelTwo extends SequentialCommandGroup {
  Elevator elevator;
  Intake intake;
  Carriage carriage;
  double distance;
  ...
  public CubeToLevelTwo(Elevator elevator, Intake intake, Carriage carriage) {
    ...
    addCommands(
      ...
      new ElevatorCommand(elevator, 65).withTimeout(0.55)
      .alongWith(new CarriageCommand(carriage, -75).withTimeout(0.55)),
